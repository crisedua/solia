    ...
    <div className="min-h-screen bg-[#0b101b] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-[#0f172a] border border-white/10 shadow-2xl p-8 text-center space-y-5">
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">¡Todo listo!</h1>
            {email && (
              <p className="text-sm text-slate-400 mt-2">
                Conectado como <span className="text-emerald-400">{decodeURIComponent(email)}</span>
              </p>
            )}
          </div>
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Tu agente de voz IA está conectado a tu cuenta de Google. Puede consultar tu disponibilidad,
            agendar citas y enviar confirmaciones automáticamente.
          </p>

          <p className="text-xs text-slate-600">Puedes cerrar esta página.</p>
        </div>
      </div>
    </div>
  );
