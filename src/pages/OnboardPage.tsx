        ...
        <div className="rounded-2xl bg-[#0f172a] border border-white/10 shadow-2xl overflow-hidden">
          ...
          {step === 'not_found' && (
            <div className="p-12 flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-base font-medium text-white">Enlace inválido</p>
              <p className="text-sm text-slate-400">Este enlace no es válido. Por favor, contáctenos.</p>
            </div>
          )}
          ...
          {step === 'form' && (
            <>
              <div className="p-6 border-b border-white/5">
                <h1 className="text-lg font-semibold text-white">Configura tu Agente de Voz IA</h1>
                <p className="text-sm text-slate-400 mt-1">Cuéntanos sobre tu negocio para comenzar.</p>
              </div>
              <div className="p-6 space-y-4">
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1.5">Tu Nombre *</label>
                ...
                <button onClick={handleRegister}
                  ...
                  {submitting ? <Icon icon="solar:refresh-linear" width={16} className="animate-spin" /> : <Icon icon="solar:arrow-right-linear" width={16} />}
          ...
          {step === 'connect_google' && (
            <>
              <div className="p-6 border-b border-white/5">
                ...
                <h1 className="text-lg font-semibold text-white">Conecta tu cuenta de Google</h1>
              </div>
              <div className="p-6 space-y-5">
                <p className="text-sm text-slate-400 leading-relaxed">
                  Para activar tu agente de voz IA, conecta tu cuenta de Google. Esto permite a tu agente:
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm text-slate-300 bg-white/5 rounded-lg p-3">
                    ...
                    <span>Consultar disponibilidad y agendar citas</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-slate-300 bg-white/5 rounded-lg p-3">
          ...
          {step === 'done' && client && (
            <>
              ...
              <div className="p-8 flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-base font-medium text-white">Tu agente está listo</p>
                <p className="text-sm text-slate-400">
                  Conectado como <span className="text-emerald-400">{client.connectedEmail}</span>.
                  Tu agente de voz IA ya puede gestionar tu calendario y enviar correos.
                </p>
              </div>
            </>
          )}
