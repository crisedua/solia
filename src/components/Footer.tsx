...
export default function Footer() {
    return (
        <footer className="bg-[#1a1a2e] border-t border-white/5 pt-20 pb-10 overflow-hidden relative">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                    ...
                    <div className="flex gap-12 md:gap-24">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <a href="#" className="text-xs text-slate-400 hover:text-white transition-colors">Blog</a>
                            <a href="#" className="text-xs text-slate-400 hover:text-white transition-colors">Contacto</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full flex justify-center items-end leading-none select-none pointer-events-none opacity-5">
                <h2 className="text-[18vw] font-bold tracking-tighter text-white whitespace-nowrap translate-y-[20%]">
                    SOL IA
                </h2>
            </div>
            ...
            <div className="border-t border-white/5 pt-8 mt-8">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    <span className="text-[10px] text-slate-500">© 2025 Sol-IA. Todos los derechos reservados.</span>
